...
public enum CardType {
    ...
    RESPITE(100, CardRarity.COMMON, "передышка", "Восстанавливает спутнику 15 здоровья.", CardTargetType.NONE),
    ...
    DOUBT(118, CardRarity.COMMON, "сомнения", "Изменяет черту героя на 10 единиц в указанную в названии сторону.", CardTargetType.NONE),
    ...
    LUCKY_THOUGHT(74, CardRarity.COMMON, "удачная мысль", "Увеличивает опыт, который герой получит за выполнение текущего задания, на 50 единиц.", CardTargetType.NONE),
    ...
    PLANTAIN(101, CardRarity.UNCOMMON, "подорожник", "Восстанавливает спутнику 53 здоровья.", CardTargetType.NONE),
    ...
    COINS_PURSE(11, CardRarity.UNCOMMON, "увесистый кошель", "Герой получает 3500 монет.", CardTargetType.NONE),
    ...
    CLEAR_MIND(75, CardRarity.UNCOMMON, "чистый разум", "Увеличивает опыт, который герой получит за выполнение текущего задания, на 175 единиц.", CardTargetType.NONE),
    ...
    SUDDEN_COMPLICATIONS(76, CardRarity.RARE, "неожиданные осложнения", "Увеличивает опыт, который герой получит за выполнение текущего задания, на 600 единиц.", CardTargetType.NONE),
    ...
    HOLY_HONEY(102, CardRarity.RARE, "священный мёд", "Восстанавливает спутнику 180 здоровья.", CardTargetType.NONE),
    ...
    COINS_CHEST(12, CardRarity.RARE, "сундучок на счастье", "Герой получает 12000 монет.", CardTargetType.NONE),
    ...
    COGNITIVE_DISSONANCE(121, CardRarity.EPIC, "когнитивный диссонанс", "Изменяет черту героя на 420 единиц в указанную в названии сторону.", CardTargetType.NONE),
    REJUVENATING_APPLE(103, CardRarity.EPIC, "молодильное яблоко", "Восстанавливает спутнику 630 здоровья.", CardTargetType.NONE),
